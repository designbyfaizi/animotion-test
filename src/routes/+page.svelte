...
<Presentation options={{ history: true, transition: 'slide', controls: false, progress: true }}>
	<Slide class="h-full place-content-center place-items-center">
		...
		>
			<p bind:this={text} class="text-4xl font-bold drop-shadow-sm flex flex-col gap-4 items-center">
				<img src="/designbyfaizi-logo.svg" alt="Design By Faizi" class="max-w-[100px]" /> <span>Design By Faizi</span>
				<span class="text-base font-normal text-stone-400">{'This is an Animotion Slide Test. Press Right Arrow Key ->'}</span>
			</p>
		</Transition>
	...
	<Slide class="h-full place-content-center place-items-center">
		<p class="mt-8 text-6xl font-bold">🪄 Thank you for watching</p>
		<p class="mt-16 text-3xl font-thin leading-normal">
			This presentation is created using Animotion.<br />Learn more by reading the
			<a
				class="font-normal text-stone-300 underline"
			...
			Visit my website
			<a
				class="font-normal text-rose-500 underline"
				href="https://designbyfaizi.com"
				target="_blank"
			>
				Design By Faizi
			</a>.
